...
const Hero = () => {
  const handleScrollToProcess = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    const target = document.getElementById("surecimiz");
    if (target) {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mb-6 max-w-4xl text-4xl font-extrabold tracking-tight text-gray-900 md:text-6xl lg:text-7xl">
            Web Siteniz İşletmenizi{" "}
            <span className="text-blue-600">Temsil Ediyor mu?</span>
          </h1>
          <p className="mb-10 max-w-2xl text-lg text-gray-600 md:text-xl">
            Hızlı, uygun fiyatlı ve yıllık masraf minimum web siteleri.
          </p>
          <a
            href="#surecimiz"
